...
class RedirectToFeedbackPageExceptionListener
{
    ...
    public function onKernelException(ExceptionEvent $event)
    {
        ...
        // Define exception mappings for better maintainability and performance
        $exceptionMappings = [
        ...
        // Handle exceptions with special processing
        if ($exception instanceof EngineBlock_Attributes_Manipulator_CustomException) {
            ...
            $redirectParams = [];
        } elseif (isset($exceptionMappings[get_class($exception)])) {
