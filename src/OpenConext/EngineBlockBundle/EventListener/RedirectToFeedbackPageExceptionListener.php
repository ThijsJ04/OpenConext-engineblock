...
public function onKernelException(ExceptionEvent $event)
{
    ...
    $exceptionMap = [
        ...
        EngineBlock_Attributes_Manipulator_CustomException::class =>
            ['authentication_feedback_custom', 'Custom Exception thrown from Attribute Manipulator'],
    ...
    if (isset($exceptionMap[$exceptionClass])) {
        ...
        $event->getRequest()->getSession()->set('feedback_custom', $message);
    ...
    if ($exception instanceof EngineBlock_Corto_Module_Bindings_UnsupportedSignatureMethodException) {
        ...
        $redirectParams['entity-id'] = $exception->getEntityId();
        $redirectParams['destination'] = $exception->getDestination();
