    ...
    public function onKernelException(ExceptionEvent $event)
    {
        ...
        $exceptionHandlers = [
            ...
            EngineBlock_Exception_UnknownIdentityProvider::class => [
                ...
                'params' => function($exception) { return ['entity-id' => $exception->getEntityId(), 'destination' => $exception->getDestination()]; }
            ],
        ...
        $redirectParams = is_callable($handler['params']) ? $handler['params']($exception) : $handler['params'];
