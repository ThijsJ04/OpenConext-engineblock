...
public function onKernelException(ExceptionEvent $event)
{
    ...
    // Handle exceptions that need special treatment first
    if ($exception instanceof EngineBlock_Corto_Module_Bindings_UnsupportedSignatureMethodException) {
        ...
        // Use map-based approach for all other exceptions
        $exceptionMap = [
    ...
    if (isset($config['session'])) {
        $event->getRequest()->getSession()->set($config['session'], $message);
    }
