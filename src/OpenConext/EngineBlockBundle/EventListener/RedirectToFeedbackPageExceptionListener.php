...
class RedirectToFeedbackPageExceptionListener
{
    ...
    public function onKernelException(ExceptionEvent $event)
    {
        ...
        // Define exception handlers in a structured way to reduce cyclomatic complexity
        $exceptionHandlers = [
        ...
        // Get redirect params if callback is defined
        $redirectParams = [];
        if (isset($handler['params_callback']) && is_callable($handler['params_callback'])) {
            $redirectParams = $handler['params_callback']($exception);
        }
