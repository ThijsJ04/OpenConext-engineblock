...
class RedirectToFeedbackPageExceptionListener
{
    ...
    public function onKernelException(ExceptionEvent $event)
    {
        ...
        if (isset($handler['session_key']) && isset($handler['session_value'])) {
            $event->getRequest()->getSession()->set($handler['session_key'], $handler['session_value']);
        }

        // Prepare redirect parameters
        $redirectParams = isset($handler['params']) ? $handler['params'] : [];
        
        // Resolve dynamic parameters
        if (isset($handler['param_callback'])) {
            $redirectParams = $handler['param_callback']($exception, $redirectParams);
        }
     ...
     * @return array
     */
    private function getExceptionHandlers()
    {
        return [
            ...
            EngineBlock_Attributes_Manipulator_CustomException::class => [
                ...
                'session_value' => function ($exception) {
                    return $exception->getFeedback();
                }
            ],
            ...
            EngineBlock_Corto_Module_Bindings_UnsupportedSignatureMethodException::class => [
                ...
                'param_callback' => function ($exception, $params) {
                    $params['signature-method'] = $exception->getSignatureMethod();
                    return $params;
                }
            ],
            ...
            EngineBlock_Exception_UnknownServiceProvider::class => [
                ...
                'param_callback' => function ($exception, $params) {
                    $params['entity-id'] = $exception->getEntityId();
                    return $params;
                }
            ],
            EngineBlock_Exception_UnknownIdentityProvider::class => [
                ...
                'param_callback' => function ($exception, $params) {
                    $params['entity-id'] = $exception->getEntityId();
                    $params['destination'] = $exception->getDestination();
                    return $params;
                }
            ],
            ...
            UnknownKeyIdException::class => [
                ...
                'param_callback' => function ($exception, $params) {
                    $params['keyid'] = $exception->getRequestedKeyId();
                    return $params;
                }
            ],
            EngineBlock_Corto_Exception_UnknownPreselectedIdp::class => [
                ...
                'param_callback' => function ($exception, $params) {
                    $params['idp-hash'] = $exception->getRemoteIdpMd5Hash();
                    return $params;
                }
            ],
