...
class RedirectToFeedbackPageExceptionListener
{
    ...
    public function onKernelException(ExceptionEvent $event)
    {
        ...
        // Define exception mappings for efficient lookup
        $exceptionMappings = [
        ...
        $mapping = $exceptionMappings[$exceptionClass];
        $message = $mapping['message'] ?? $exception->getMessage();
        $redirectToRoute = $mapping['route'];
        $redirectParams = $mapping['params'];
        ...
        // Handle exceptions with dynamic parameters
        if ($exception instanceof EngineBlock_Corto_Module_Bindings_UnsupportedSignatureMethodException) {
