...
public function onKernelException(ExceptionEvent $event)
{
    ...
    $httpRequest = $this->engineBlockApplicationSingleton->getHttpRequest();
    $this->logger->notice(sprintf("[404]Unroutable URI: '%s'", $httpRequest->getUri()));

    $response = new Response($this->twig->render('@theme/Default/View/Error/not-found.html.twig'), 404);
