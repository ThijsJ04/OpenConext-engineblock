...
public function applyArpAction(Request $request)
{
    ...
    $showSources = isset($body['showSources']) && is_bool($body['showSources']) && $body['showSources'];
    ...
    $arpEnforcer = $this->arpEnforcer;

    foreach ($entityIds as $entityId) {
        $arp = $metadataService->findArpForServiceProviderByEntityId(new EntityId($entityId));
        $releasedAttributes[$entityId] = $arpEnforcer->enforceArp($attributes, $arp, $showSources);
    }
