...
public function getLocale()
{
    ...
    $queryLang = $this->request->query->get('lang');
    if (in_array($queryLang, $this->availableLocales, true)) {
        return $queryLang;
    }

    $requestLang = $this->request->request->get('lang');
    if (in_array($requestLang, $this->availableLocales, true)) {
        return $requestLang;
    }

    $cookieLang = $this->request->cookies->get('lang');
    if (in_array($cookieLang, $this->availableLocales, true)) {
        return $cookieLang;
    }
    ...
    $preferredLanguage = $this->request->getPreferredLanguage($availableLocales);
