...
public function getLocale()
{
    ...
    if (is_string($lang) && in_array($lang, $this->availableLocales, true)) {
        return $lang;
    }
    ...
    $lang = $this->request->cookies->get('lang');
    if (is_string($lang) && in_array($lang, $this->availableLocales, true)) {
        return $lang;
    }
    ...
    return $preferredLanguage !== null ? $preferredLanguage : $this->defaultLocale;
}
}
