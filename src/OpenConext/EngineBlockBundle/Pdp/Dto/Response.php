...
public static function fromData(array $jsonData) : Response
{
    ...
    $status->statusCode->value = $responseData['Status']['StatusCode']['Value'];
    if (isset($responseData['Status']['StatusDetail'])) {
        $status->statusDetail = $responseData['Status']['StatusDetail'];
    }
    if (isset($responseData['Status']['StatusMessage'])) {
        $status->statusMessage = $responseData['Status']['StatusMessage'];
    }
    ...
    if (isset($responseData['AssociatedAdvice'])) {
        ...
        foreach ($responseData['AssociatedAdvice'] as $associatedAdviceData) {
            ...
            $associatedAdvice->attributeAssignments = $attributeAssignments;
            $associatedAdvices[] = $associatedAdvice;
        }
        $response->associatedAdvices = $associatedAdvices;
    }
    ...
    if (isset($responseData['Obligations'])) {
        ...
        foreach ($responseData['Obligations'] as $obligationData) {
            ...
            $obligation->attributeAssignments = $attributeAssignments;
            $obligations[] = $obligation;
        }
        $response->obligations = $obligations;
    }

    $policyIdentifier = new PolicyIdentifier;
    if (isset($responseData['PolicyIdentifier']['PolicySetIdReference'])) {
        ...
        $policyIdentifier->policySetIdReference = $policySetIdReferences;
    }
    ...
    if (isset($responseData['PolicyIdentifier']['PolicyIdReference'])) {
        ...
        $policyIdentifier->policyIdReference = $policyIdReferences;
    }
    $response->policyIdentifier = $policyIdentifier;
