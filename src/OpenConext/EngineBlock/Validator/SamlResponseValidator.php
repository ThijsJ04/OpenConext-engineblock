...
private function verifyAssertionCorrectlySigned(DOMNode $document)
{
    ...
    $childNodes = $signature->childNodes;

    if ($childNodes->length < 2) {
        throw new InvalidSamlResponseException('Signature must contain at least SignedInfo and SignatureValue elements.');
    }

    $signedInfo = $childNodes->item(0);
