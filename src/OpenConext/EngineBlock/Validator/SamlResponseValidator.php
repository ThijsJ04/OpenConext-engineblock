...
class SamlResponseValidator implements RequestValidator
{
    ...
    private function verifyAssertionCorrectlySigned(DOMNode $document)
    {
        ...
        // Early return if no signatures - unsigned assertions are allowed
        ...
        // Validate SignatureValue element
        ...
        // Validate only one SignedInfo element exists
