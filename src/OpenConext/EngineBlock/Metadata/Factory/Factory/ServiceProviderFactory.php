...
public function createStepupEntityFrom(string $keyId): ServiceProviderEntityInterface
{
    ...
    $entityId = $isConfigured && $this->featureConfiguration->isEnabled('eb.stepup.sfo.override_engine_entityid')
        ? ($this->entityIdOverrideValue ?: throw new MissingParameterException(
