...
public function __construct(
    ...
    $this->contactPersons = [
        ContactPerson::from('support', $organizationName, 'Support', $supportMail),
        ContactPerson::from('technical', $organizationName, 'Support', $supportMail),
        ContactPerson::from('administrative', $organizationName, 'Support', $supportMail)
    ];
}
