...
public function __construct(
    ...
    $contactPersonType = 'Support';
    $this->contactPersons = [
        ContactPerson::from('support', $this->organizationName, $contactPersonType, $this->supportMail),
        ContactPerson::from('technical', $this->organizationName, $contactPersonType, $this->supportMail),
        ContactPerson::from('administrative', $this->organizationName, $contactPersonType, $this->supportMail)
    ];
}
