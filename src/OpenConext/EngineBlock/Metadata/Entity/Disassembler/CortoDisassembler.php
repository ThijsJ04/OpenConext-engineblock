...
private function translateOrganization(AbstractRole $entity, array $cortoEntity)
{
    ...
    foreach ($languages as $lang) {
        ...
        if (isset($entity->$org) && $entity->$org) {
            foreach ($fields as $field) {
                if (isset($entity->$org->$field)) {
                    $this->mapMultilang($entity->$org->$field, $cortoEntity, 'Organization', ucfirst($field), $lang);
                }
            }
        }
    }
...
private function translateContactPersons(AbstractRole $entity, array $cortoEntity)
{
    ...
    $cortoEntity['ContactPersons'] = array_map(function ($contactPerson) {
        return [
