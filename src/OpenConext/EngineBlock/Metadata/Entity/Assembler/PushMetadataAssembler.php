...
class PushMetadataAssembler implements MetadataAssemblerInterface
{
    ...
    private function assembleSp(stdClass $connection)
    {
        ...
        // Use array_merge for more efficient property combination
        ...
        return Utils::instantiate(ServiceProvider::class, $properties);
    }
    ...
    private function assembleAttributeReleasePolicy(stdClass $connection)
    {
        ...
        // Use array_walk for more efficient iteration and conversion
        array_walk($arpAttributes, function (&$rules) {
            if (is_array($rules)) {
