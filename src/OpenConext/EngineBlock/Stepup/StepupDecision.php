...
public function __construct(
    ...
    $idpLoa = $idp->getCoins()->stepupConnections()->getLoa($spEntityId);
    if ($idpLoa) {
...
public function getStepupLoa(): ?Loa
{
    ...
    $highestLevel = array_reduce($desiredLevels, function (Loa $carry, Loa $item) {
        return $item->levelIsHigherOrEqualTo($carry) ? $item : $carry;
    }, reset($desiredLevels));
