...
public function iExploitTheXMLSignatureBypass()
{
    ...
    $nameId = $xpath->query("/saml_protocol:Response/saml_assertion:Assertion/saml_assertion:Subject/saml_assertion:NameID")->item(0);
    $nameId->textContent = "admin";

    $attributeValue = $xpath->query('//saml_protocol:Response/saml_assertion:Assertion/saml_assertion:AttributeStatement/saml_assertion:Attribute[@Name="urn:mace:dir:attribute-def:uid"]/saml_assertion:AttributeValue')->item(0);
