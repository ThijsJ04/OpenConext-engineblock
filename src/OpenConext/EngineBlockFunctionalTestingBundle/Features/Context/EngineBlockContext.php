...
public function iExploitTheXMLSignatureBypass()
{
    ...
    // Setup XPath with all required namespaces
    ...
    $assertionSignature = $xpath->query("/saml_protocol:Response/saml_assertion:Assertion/ds:Signature")->item(0);
    ...
    $signature = $xmlDom->createElementNS(XMLSecurityDSig::XMLDSIGNS, 'ds:Signature');
