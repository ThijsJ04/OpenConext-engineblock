...
public function theCollabPersonIdIsPresent()
{
    ...
    $xpath = '/samlp:Response/saml:Assertion/saml:AttributeStatement/saml:Attribute[@Name="urn:mace:surf.nl:attribute-def:internal-collabPersonId"]';
    $nodeListAttribute = $xpathObj->query($xpath);
    ...
    $nodeListAttributeValue = $xpathObj->query("$xpath/saml:AttributeValue");
    ...
    if (strpos($value, 'urn:collab:person:') !== 0) {
        throw new ExpectationException(
