...
class Container extends AbstractContainer
{
    ...
    /**
     * Build form data HTML from the data array.
     *
     * @param array $data
     * @return string
     */
    ...
    /**
     * Process SAMLRequest data and return formatted XML or default value.
     *
     * @param array $data
     * @return string
     */
    ...
    /**
     * Process SAMLResponse data and return formatted debug HTML or empty string.
     *
     * @param array $data
     * @return string
     */
