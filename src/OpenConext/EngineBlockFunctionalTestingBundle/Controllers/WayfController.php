...
public function wayfAction(Request $request)
{
    ...
    $backLink = $request->get('backLink') !== null;
    $displayUnconnectedIdpsWayf = $request->get('displayUnconnectedIdpsWayf') !== null;
    $addDiscoveries = $request->get('addDiscoveries') !== null;
    $rememberChoiceFeature = $request->get('rememberChoiceFeature') !== null;
