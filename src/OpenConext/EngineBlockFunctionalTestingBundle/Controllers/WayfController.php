...
public function wayfAction(Request $request)
{
    ...
    $backLink = $request->getBoolean('backLink');
    $displayUnconnectedIdpsWayf = $request->getBoolean('displayUnconnectedIdpsWayf');
    $addDiscoveries = $request->getBoolean('addDiscoveries', true);
    $rememberChoiceFeature = $request->getBoolean('rememberChoiceFeature');
    ...
    $defaultIdpEntityId = $request->get('defaultIdpEntityId');
    $connectedIdps = $request->getInt('connectedIdps', 5);
    $unconnectedIdps = $request->getInt('unconnectedIdps');
    $randomIdps = $request->getInt('randomIdps');
